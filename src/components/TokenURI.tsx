...
//console.log(domainId);
  ...
  //const url = "https://web3yak.com/endpoint/v1/index.php?domain=" + domainName + "&" + randomNumber+"&update=yes";
  const url = "https://web3yak.com/endpoint/v3/index.php?name=" + domainName + "&" + randomNumber+"&update=yes&type=uri";
